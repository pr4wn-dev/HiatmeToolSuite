    ...
    internal static class ScheduleBuilderGroupNotes
    {
            ...
            Color? textColor = null)
        {
            ...
            if (hasHeader)
            {
                ...
                lines[headerIdx].GroupNoteTextColor = textColor;
        ...
        public static bool TryReadNote(
            ...
            out bool centerText)
            => TryReadNote(lines, groupNumber, out noteText, out noteRowColor, out centerText, out _);
        ...
        private static bool ShouldRemoveEmptyHeader(ScheduleBuilderPreviewLine header)
        {
            ...
            return string.IsNullOrWhiteSpace(header.GroupNoteText)
                ...
                && !header.GroupNoteCenterText
                && !header.GroupNoteTextColor.HasValue;
        }
