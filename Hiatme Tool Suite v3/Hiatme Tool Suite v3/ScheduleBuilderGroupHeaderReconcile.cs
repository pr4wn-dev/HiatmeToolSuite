...
namespace Hiatme_Tool_Suite_v3
{
    ...
    internal static class ScheduleBuilderGroupHeaderReconcile
    {
        public static List<ScheduleBuilderPreviewLine> Reconcile(IList<ScheduleBuilderPreviewLine> lines)
        {
            ...
            Color? pendingNoteTextColor = null;
            int groupNumber = 0;
            ...
            void FlushSegment()
            {
                ...
                if (note.Length > 0
                    || pendingColorOverride.HasValue
                    || pendingNoteRowColor.HasValue
                    || pendingNoteCenterText
                    || pendingNoteTextColor.HasValue)
                {
                    result.Add(new ScheduleBuilderPreviewLine
                    {
                        ...
                        GroupNoteTextColor = pendingNoteTextColor,
                    });
                }
            ...
            foreach (var line in lines)
            {
                ...
                switch (line.Kind)
                {
                    case ScheduleBuilderPreviewLine.LineKind.GroupHeader:
                        ...
                        pendingNoteTextColor = line.GroupNoteTextColor;
                        break;
